						...
						<div class="login">
							...
							<div class="login_body">
								<form method="post" action="/idSearch">
									<input id="mm_name" type="text" name="mm_name" required
										placeholder="이름"> <br> <input id="mm_pnum"
										type="text" name="mm_pnum" required placeholder="전화번호"
										title="전화번호"> <br>
									<button type="button" class="loginBtn" id="idSearchBtn">아이디찾기</button>
								</form>
